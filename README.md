...
# Kuka MatLab Files
This folder contains the simulink model of the manipulator converted using simechanics. A tuned PID controller is used for controlling each joint's motion.
